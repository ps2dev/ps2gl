...
void
CIndexedRenderer::InitContext( GLenum primType, tU32 rcChanges, bool userRcChanged )
{
...
int
CIndexedRenderer::GetPacketQwordSize( const CGeometryBlock &geometry )
{
...
bool
CIndexedRenderer::GetCachePackets( const CGeometryBlock &geometry )
{
...
void
CIndexedRenderer::DrawIndexedArrays( CGeometryBlock &block )
{
   // TODO:
